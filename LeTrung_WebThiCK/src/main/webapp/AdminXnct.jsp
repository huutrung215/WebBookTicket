...
<body>
	<nav>
		<!--logo  -->
		<a href="AdminChinhController.java" class="logo">
    ...
    <div>
        <table class="table table-striped" style="width:100%">
            ...
            <c:forEach items="${viewCt}" var="c">
                <tr>
                    <td>${c.getIdUser()}</td>
                    <td>${c.getIdChiTiet()}</td>
                    ...
                    <td>${c.getGia()}</td>
                    <td>${c.isDamuaCt()}</td>
                    <td><a href="AdminXnChuyenTienController?xid=${c.getIdChiTiet()}&damua=${c.isDamuaCt()}">
				           Xác nhận
				        </a> </td>
                </tr>
            </c:forEach>
