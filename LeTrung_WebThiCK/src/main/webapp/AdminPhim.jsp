		...
		<div class="movies-box">
			...
			<!--test  -->
			 <div class="latest-b-text">
                   ...
                   <p>${o.theloai }</p>
                   <div><a href="AdminXoaPhimController?idp=${o.id}" style="text-decoration: none;" name="${o.id}" class="btn btn-sm btn-danger">Xóa</a>
                   		<a href="AdminSuaPhimCon?idph=${o.id}" style="text-decoration: none;" name="${o.id}" class="btn btn-sm btn-primary">Sửa</a>
                   </div>
               </div>
		</div>
	</c:forEach>
