...
<section class="container">
	<form method="post" action="AdminSuaScController">
		<div class="mb-3 mt-3">
		    <label for="ngaychieu" class="form-label">Ngày chiếu:</label>
		    <select id="ngaychieu" class="form-control form-control-lg" name="ssdate" >
		  ...
		  <div class="mb-3 mt-3">
		    ...
		    <select id="thgianchieu" class="form-control form-control-lg" name="sstime">
		  ...
		  <div class="mb-3 mt-3">
		    ...
		    <input type="text" value="${sessionScope.movie }" class="form-control" id="tenphim" name="tphim"/>
		  </div>
		  <div class="mb-3">
		    <label for="chinhanh" class="form-label">Chi nhánh:</label>
		    <input type="text" value="${sessionScope.location }" class="form-control" id="chinhanh" name="tchinhanh"/>
		  </div>
		  <div class="mb-3 mt-3">
		    <label for="phong" class="form-label">Phòng:</label>
		      <input type="text" value="${sessionScope.room }" class="form-control" id="phong" name="tphong"/>
		  </div>
		  <div class="mb-3 mt-3">
		    <label for="gia" class="form-label">Gía:</label>
		      <input type="text" value="${sessionScope.price }" class="form-control" id="gia" name="tgia"/>
		  </div>
