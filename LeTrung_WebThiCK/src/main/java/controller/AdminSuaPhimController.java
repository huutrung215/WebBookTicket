...
/**
 * Servlet implementation class AdminSuaPhimController
 */
@WebServlet("/AdminSuaPhimController")
public class AdminSuaPhimController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminSuaPhimController() {
        super();
...
//					response.getWriter().println(fileItem.getString());
				...
				if(tentk.equals("theloai"))
				{
//					response.getWriter().println(fileItem.getString());
					loai = fileItem.getString();
					AdminThemPhimDao dao = new AdminThemPhimDao();
					dao.editPhim(id, tenphim, "images/"+nameimg, loai);
