...
/**
 * Servlet implementation class AdminThemScCon
 */
@WebServlet("/AdminThemScCon")
public class AdminThemScCon extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminThemScCon() {
        super();
...
//			 LocalDate today = LocalDate.parse("2022-12-17"); 
			...
			request.getRequestDispatcher("AdminThemSc.jsp").forward(request, response);
		} catch (Exception e) {
